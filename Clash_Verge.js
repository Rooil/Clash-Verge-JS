...
function overwriteRules (params) {
    ...
    const ipRules = [
        ...
        "RULE-SET,google_cn_proxy_ip,谷歌CN",//修改
        //自带非IP规则
    ...
    const ruleProviders = {
        ...
        telegram_non_ip: {
            ...
            path: "./rules/sukkaw_ruleset/telegram_non_ip.txt",
            interval: 43200,
            format: "text",
            proxy: "节点选择"
        },
        telegram_ip: {
            ...
            path: "./rules/sukkaw_ruleset/telegram_ip.txt",
            interval: 43200,
            format: "text",
            proxy: "节点选择"
        },
...
function overwriteProxyGroups (params) {
    ...
    const groups = [
        ...
        },
        {
            ...
            proxies: ["手动切换", "特殊", "节点选择", "下载节点", "香港节点", "狮城节点", "台湾节点", "日本节点", "韩国节点", "美国节点", "其它节点", "DIRECT",],
        },
        {
            name: "JAV",
            type: "select",
            ...
            proxies: ["手动切换", "节点选择", "特殊", "下载节点", "香港节点", "狮城节点", "台湾节点", "日本节点", "韩国节点", "美国节点", "其它节点", "DIRECT",],
        },
        {
            name: "PIKPAK",
            type: "select",
